...
class TrainConfig(BaseConfig):
    ...
    continue_from_path = 'checkpoints/BrainAge_autoenc_130M/new_model.ckpt' 
    from_ckpt: bool = True 
    ...
    alpha = 1.5 #scale the contrastive loss
    _lambda = 0.3 #scale the ortho loss
    beta = 1.5 #scale the network loss 
    num_epochs = 1000
    epsilon = 1e-4  
    Proto = True 
    KL = True
    ...
    def make_dataset(self, path=None, **kwargs):
          return ExampleDataset(train = True) #3561
